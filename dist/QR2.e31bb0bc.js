...
$(function () {
  function tileHandler(tile) {
    ...
    $tiles.each(function () {
      $(this).click(function () {
        var $target = $(this); // raise elements to the top of the viewport

        if ($(this).css("top") == "0px") {
          var $titles = $(this).find(".title"); // Prevent iterations
          ...
          $target.find(".details").addClass("overflow-auto").removeClass("d-none");
        }
    ...
    $(".nav__button").click(function () {
      ...
      $tiles.each(function () {
        if ($(this).css("top") == "0px") {
          ...
          $(this).css("top", 0).removeClass("col-12").addClass("rounded").find(".details").addClass("d-none").removeClass("overflow-auto");
        }
      });
...
//# sourceMappingURL=/QR2.e31bb0bc.js.map